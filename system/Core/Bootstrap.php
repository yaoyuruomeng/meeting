...
class Core_Bootstrap
{
    ...
    public function initGlobal()
    {
        ...
        Yaf_Loader::import(APP_PATH . 'library/Function/Common.php');
        Yaf_Loader::import(APP_PATH . 'library/Function/Wx.php');
        Yaf_Loader::import(APP_PATH . 'library/Function/Set.php');
        Yaf_Loader::import(APP_PATH . 'library/Function/App.php');
